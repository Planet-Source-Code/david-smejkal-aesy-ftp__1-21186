...
MsgBox "Opertion Canceled.", vbInformation
End If
End Sub
...
Command1.Enabled = True
    For i = 0 To List1.ListCount - 1
           ...
           With ProgressBar1
            ...
            frmmain.txtInfo.SelText = Time & " > Accomplishing data transfer..." & vbCrLf & " > Downloading from: " & Ode & ", to: " & Kam & vbCrLf
            frmmain.StatusBar1.Panels(2).Text = "Transfering data..., wait."
              hFile = FtpOpenFile(server, Ode, GENERIC_READ, FTP_TRANSFER_TYPE_BINARY, 0)
                 If hFile = 0 Then
                   MsgBox "Can't open file path!", vbExclamation, "Problém s URL"
...
Command1.Enabled = True
    For i = 0 To List1.ListCount - 1
           ...
           With ProgressBar1
            ...
            frmmain.txtInfo.SelText = Time & " > Begining data transfer..." & vbCrLf & " > Uploading from: " & Ode & ", to: " & Kam & vbCrLf
            frmmain.StatusBar1.Panels(2).Text = "uploading data..., wait."
                ...
                Do
                    ...
                    If nFileLen < nTotFileLen - sReadBuffer Then
                        If InternetWriteFile(hFile, sBuffer, sReadBuffer, nRet) = 0 Then
                            MsgBox "Nastala chyba pøi pøevodu dat!", vbExclamation, App.Title
                            frmmain.txtInfo.SelText = Time & " > Nastala chyba pøi pøevodu dat! Požadavek stornován!" & vbCrLf
                            Exit Do
                        End If
